...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Market and Deal : Everything Template</title>
        ...
        <!-- <link rel="stylesheet" type="text/css" href="css/em_cloudzoom.css" media="all" /> -->
         <link rel="stylesheet" type="text/css" href="<?php echo  asset_url();?>css\custom_css.css" media="all">
        <!-- Menu CSS -->
                ...
                <div class="em-wrapper-header">
                    <div id="em-mheader" class="visible-xs container">
                        <div id="em-mheader-top" class="row">
                            <div id="em-mheader-logo" class="col-xs-4">
                                <div class="em-logo"><a href="<?php echo base_url(); ?>" title="Market and Deal Commerce" class="logo"><strong>Market and Deal Commerce</strong><img src="images/logo_small.png" alt="Market and Deal Commerce"></a>
                                </div>
                            </div>
                            <div class="col-xs-20">
                    ...
                    <div class="hidden-xs em-header-style31">
                                    ...
                                    <div class="col-sm-24">
                                        <div class="em-wrapper-header-top">
                                            ...
                                            <div class="em-top-links">
                                                ...
                                                <div class="f-right">
                                                    <ul class="links">
                                                        <li class="first last"><a href="multidealpro.html" title="Order By Phone: +91888288888" class="top-link-deal">Order By Phone: +91 888288888</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="f-right">
                                                    <ul class="em-links-wishlist">
                                                        <li class="first last"><a href="wishlist.html" title="Track Order">Track Order</a>
                                                        </li>
                                                    </ul>
                                                </div>
                        ...
                        <div class="em-header-middle">
                            <div class="container">
                                <div class="row">
                                    <div class="em-logo col-sm-6"><a href="<?php echo base_url(); ?>" title="Magento Commerce" class="logo"><strong>Magento Commerce</strong><img class="retina-img" src="images/logo.png" alt="Magento Commerce"></a>
                                    </div>
                                    <div class="col-sm-18">
                                    ...
                                    <div class="col-sm-24">
                                        <div class="em-line">
                                            <div class="em-logo-sticky f-left">
                                                <a href="#" title="Magento Commerce" class="logo"><img src="images/logo_small.png" alt="Magento Commerce">
                                                </a>
                                            </div>
