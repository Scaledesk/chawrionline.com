            ...
            <header>Seller Add Multiple Product </header>
                <div class="products">
                   <div class="products_name"> <select required name="categories[]" class="input-text  required-entry">
                    ...
                    <div class="multi-add products_substance"> <input type="number" step="any" required placeholder="GSM" name="products_substance[]"class=" input-text"></div>
                    
                    <div class="multi-add products_size"><input type="number" id="firstname"  step="any" required placeholder="Size" name="products_size[]" title="  Size" maxlength="255" class=" input-text size-box1">
                    
                                                                        <span>X</span> 
                    <input type="number" step="any" id="firstname" step="any" required  name="products_size_one[]"  placeholder=" Size" maxlength="255" class="input-text size-box2"> <!-- <input type="number"  required placeholder="Products Size" name="products_size[]"> --></div>
                    
                    <div class="multi-add products_thickness"> <input type="number" step="any" required placeholder="Bulk (mic)" name="products_thickness[]" class=" input-text"></div>
                    ...
                    <div class="multi-add products_sheets_per_packet"> <input required type="number" step="any" placeholder="Sheets per Packet" name="products_sheets_per_packet[]" class=" input-text"></div>
                     <div class="products_weight"> <input type="number" step="any" required placeholder="Pkt. Weight " name="products_weight[]" class=" input-text"></div>
                    <div class="multi-add packets_per_bundle"><input type="number" step="any"  required placeholder="Products Per Bundle" name="packets_per_bundle[]" class=" input-text"></div>
                    <div class="multi-add products_quantity_on_offer"> <input step="any" required type="number" placeholder="Quantity on Offer (in pkts)" name="products_quantity_on_offer[]" class=" input-text"></div>
                    ...
                    <div class="multi-add products_rate"> <input type="number" required step="any" placeholder="Products Rate" name="products_rate[]" class=" input-text"></div>
                    <div class="multi-add products_cenvat_amount"> <input type="number" step="any" required placeholder="Products Cenvat Amount" name="products_cenvat_amount[]" class=" input-text"></div> 
            ...
            <script type="text/javascript">
                ...
                $( document ).ready(function() {
                    ...
                    $(".addmore").click(function() {
                        ...
                        var products_substance = $("<div id='products_substance_"+rowNum+"'style='float: left' class='products_substance'><input type='number' step='any' required  placeholder='GSM'name='products_substance[]'class='input-text required-entry'></div>");
                        var products_size = $("<div id='products_size_"+rowNum+"'style='float: left' class='products_size'><input type='number' placeholder='Size'step='any' id='firstname'  required  name='products_size[]' title=' Size' maxlength='255' class='input-text size-box1'><span>X</span> <input type='number'step='any' placeholder='Size'id='firstname'  required  name='products_size_one[]' title='Size' maxlength='255' class='input-text size-box2'></div>");
                        var products_thickness = $("<div id='products_thickness_"+rowNum+"' style='float: left' class='products_thickness'><input type='number'step='any' placeholder='Bulk (mic)' name='products_thickness[]'class='input-text required-entry'></div>");
                        ...
                        var products_weight = $("<div id='products_weight_"+rowNum+"' style='float: left' class='products_weight'><input type='number' step='any' placeholder='Products Per Bundle' required name='products_weight[]'class='input-text required-entry'></div>");
                        var packets_per_bundle = $("<div id='packets_per_bundle_"+rowNum+"' style='float: left' class='packets_per_bundle'><input type='number'step='any' placeholder='Products Per Bundle' required name='packets_per_bundle[]'class='input-text required-entry'></div>");
                        var products_quantity_on_offer = $("<div id='products_quantity_on_offer_"+rowNum+"'style='float: left'  class='products_quantity_on_offer'><input type='number'step='any' required placeholder='Quantity on Offer (in pkts)' name='products_quantity_on_offer[]'class='input-text required-entry'></div>");
                        ...
                        var products_rate = $("<div id='products_rate_"+rowNum+"' style='float: left' class='products_rate'><input type='number' step='any' placeholder='Products Rate' required name='products_rate[]'class='input-text required-entry'></div>");
                        var products_cenvat_amount = $("<div id='products_cenvat_amount_"+rowNum+"'style='float: left' class='products_cenvat_amount'><input type='number'step='any'required placeholder='Products CENVAT Amount'name='products_cenvat_amount[]'class='input-text required-entry'></div> </br> </br> </br><br>");
