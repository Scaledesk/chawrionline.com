                ...
                <div class="products">
                 <div class=" row col-sm-24">
                   ...
                   <div class=" row col-sm-24"> 
                    ...
                    <div class="multi-add products_cenvat_amount col-sm-6"> <input type="number" step="any" minlength="0" required placeholder="Products Cenvat Amount" name="products_cenvat_amount[]" class=" input-text"></div> 
                    </div>
                </div>
