                ...
                <div class="products">
                 <div class=" row col-sm-24">
                   ...
                   <div class=" row col-sm-24"> 
                    ...
                    <div class="multi-add products_rate col-sm-6"> <input type="number" step="any" minlength="0" required  placeholder="Product Rate" name="products_rate[]" class=" input-text"></div>
