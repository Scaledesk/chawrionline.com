            ...
            <script type="text/javascript">
                ...
                $( document ).ready(function() {
                    ...
                    $(".addmore").click(function() {
                        ...
                        var products_cenvat_amount = $("<div class='row col-sm-24'><div id='products_cenvat_amount_"+rowNum+"'style='float: left' class='col-sm-6 products_cenvat_amount'><input type='number' step='any' minlength='0' required placeholder='Products CENVAT Amount'name='products_cenvat_amount[]' class='input-text required-entry'></div><br>");
