                    ...
                    <div id="em-mheader" class="visible-xs container">
                        <div id="em-mheader-top" class="row">
                            <div id="em-mheader-logo" class="col-xs-4">
                                ...
                                <strong>Chawri Oline </strong><img src="<?php echo  asset_url();?>images/chawrionline_logo_small.jpg" alt="Market and Deal Commerce"></a>
                                </div>
                            </div>
                                                        ...
                                                        <form action="<?php  echo base_url().'users/searchProduct'; ?>" method="post">
                                                            <div class="form-search no_cate_search">
                                                                <div class="text-search">
                                                                    ...
                                                                    <div style="float: left; width: 33%;" > <input id="search1" type="number" min="1" max="999" step="1"name="gsm" class="input-text required-entry"  maxlength="3"  placeholder="GSM "></div>
