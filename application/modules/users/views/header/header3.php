                    ...
                    <div id="em-mheader" class="visible-xs container">
                        <div id="em-mheader-top" class="row">
                            <div id="em-mheader-logo" class="col-xs-4">
                                <div class="em-logo"><a href="<?php echo base_url(); ?>" title="Market and Deal Commerce" class="logo"><strong>
                                Market and Deal Commerce</strong><img src="images/logo_small.png" alt="Market and Deal Commerce"></a>
                                </div>
                            </div>
                            <div class="col-xs-20">
