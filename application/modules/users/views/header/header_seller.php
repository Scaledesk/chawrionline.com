                    ...
                    <div id="em-mheader" class="visible-xs container">
                        <div id="em-mheader-top" class="row">
                            <div id="em-mheader-logo" class="col-xs-4">
                                <div class="em-logo"><a href="<?php echo base_url(); ?>" title="Market and Deal Commerce" class="logo"><strong>Chawri Oline </strong><img src="images/chawrionline_logo_small.jpg" alt="Market and Deal Commerce"></a>
                                </div>
                            </div>
                            <div class="col-xs-20">
                                                            ...
                                                            <div class="em_nav" id="toogle_menu_4_8356">
                                                                <ul class="hnav em_hoz_menu effect-menu">
                                                                    <li class="menu-item-link menu-item-depth-0  menu-item-parent">
                                                                        <a class="em-menu-link" href="<?php echo base_url().'sellers/homeSeller' ?>"> <span> Home </span> </a>
...
<li class="menu-item-link menu-item-depth-0  menu-item-parent">
                                                                    ...
                                                                    <!-- /.menu-item-link -->
                                                                    <li class="menu-item-link menu-item-depth-0  menu-item-parent">
                                                                        <a class="em-menu-link" href="<?php echo  base_url().'users/contactsSelles';?>"> <span> Contact Us </span> </a>
