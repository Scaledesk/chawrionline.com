                                            ...
                                            <form action="<?php echo base_url().'users/information';?>" method="post" id="form-validate">
                                                <div class="fieldset">
                                                    ...
                                                    <input type="hidden" name="error_url" value="">
                                                     <h2 class="profile-text"><a href="<?php echo base_url().'users/getUpdateUsers'?>">General Information </a></h2> &nbsp &nbsp &nbsp<h2 class="profile-text2"><a href="<?php echo base_url().'users/updateInformation'?>">Account  Information </a></h2>
