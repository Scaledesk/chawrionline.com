                                        ...
                                        <div class="account-create">
                                            <div class="page-title">
                                                ...
                                                <div class="fieldset">
                                                   ...
                                                   <!--  <h2 class="profile-text"><a href="<?php echo base_url().'users/getUpdateUsers'?>">General Information </a></h2> &nbsp &nbsp &nbsp<h2 class="profile-text">Account  Information</h2> -->
                                                    <ul class="form-list">
                                                        <li class="fields">      
                                                        ...
                                                        <li class="fields">
                                                         ...
                                                         <li class="fields">
                                                            <div class="customer-name-middlename">
                                                                ...
                                                                <div class="field name-firstname">
                                                                    <label for="phone" class="required">Tin No</label>
                                                                    <div class="input-box">
                                                    ...
                                                    <div class="buttons-set">
                                                         ...
                                                         <button type="submit" title="Place" class="button"><a href="<?php echo base_url().'users/updateInformation';?>">Update</a></button>
